...
(function ($) {
    $.Dialog = function (params) {
        ...
        if (params.position.zone == "left") {
            ...
            $('#dialogBox').css("top", ((params.position.offsetY) ? (params.position.offsetY) : ($(window).height() - $('#dialogBox').outerHeight()) / 2));
            $('#dialogBox').css("left", ((params.position.offsetX) ? (params.position.offsetX) : ($(window).width() - $('#dialogBox').outerWidth()) / 2));
            /*
